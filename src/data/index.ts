...
export const testimonial_data = [
  {
    ...
    desc: `Having worked in the industry for only a handful of years, I consider
...
export const chart_data = [
  {
    slug: "Overall",
    labels: ["Front-End", "Backend", "Database", "Design", "Cloud", "Devop"],
    data: ["10", "9", "8", "8", "6", "7"],
  },
];
